...
<body class="bg-gradient-to-br from-slate-900 to-black min-h-screen relative">
    <div class="lg:container mx-auto px-4 py-4 sm:py-8 mb-16">
    ...
    <a href="{{ route('home') }}" class="fixed left-1/2 -translate-x-1/2 bottom-4  p-4 bg-slate-400/50 rounded-full hover:scale-105 hover:bg-purple-700 transform duration-150">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-white w-max rouned-full">
